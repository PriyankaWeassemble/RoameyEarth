...
//		driver.manage().window().maximize();
		...
		email1.sendKeys("mahalaxmi@weassemble.team");
		...
		WebElement passwor=driver.findElement(By.xpath("/html/body/div[1]/div/div/div[2]/div[1]/div[2]/div/div/div[2]/div/div/form/div[2]/div/div/input"));
		passwor.sendKeys("Indira@77");
